 ...
 *
 * $Header: /usr2/eric/vg/atari/vecsim/RCS/pokey.c,v 1.2 1997/05/17 22:25:36 eric Exp $
 */
...
u8 pokey_rreg [MAX_POKEY][MAX_REG];

u8 pokey_wreg [MAX_POKEY][MAX_REG];

#ifdef POKEY_DEBUG
u8 pokey_wreg_inited [MAX_POKEY][MAX_REG] = { { 0 } };
#endif
